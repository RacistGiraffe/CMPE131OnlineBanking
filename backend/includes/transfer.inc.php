...
if (isset($_POST['transfer-submit'])) {
    ...
    $resultBalance = mysqli_query($conn, "UPDATE users SET balanceUsers = $balance WHERE uidUsers = 'ruchirTest';");
    $resultBalanceTwo = mysqli_query($conn, "UPDATE users SET balanceTwoUsers = $balanceTwo WHERE uidUsers = 'ruchirTest';");
